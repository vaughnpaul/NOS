...
// class constructor
   function zones() {
     ...
     if (defined('MODULE_SHIPPING_ZONES_SORT_ORDER')) {
     ...
     $this->icon = '';
     if (defined('MODULE_SHIPPING_ZONES_TAX_CLASS')) {
   ...
   function install() {
     ...
     for ($i = 1; $i <= $this->num_zones; $i++) {
      ...
      $default_countries = 'NL';
       ...
       if ($i == 2) {
         $default_countries = 'AT,BE,GB,DE,FR,GL,<br>IS,IE,IT,NO,DK,PL,<br>ES,SE,CH,FI,PT,IL,GR';
