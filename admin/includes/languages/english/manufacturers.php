...
define('TEXT_MANUFACTURERS_HTC_TITLE', 'Header Tags Manufacturer Title:');
define('TEXT_MANUFACTURERS_HTC_DESC', 'Header Tags Manufacturer Description:');
define('TEXT_MANUFACTURERS_HTC_KEYWORDS', 'Header Tags Manufacturer Keywords:');
